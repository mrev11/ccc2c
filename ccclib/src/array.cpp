...
// A simplehash osztály hashitem, get metódusát
...
//------------------------------------------------------------------------
void array(int len) //stackrõl levett elemekkel inicializált array
{
// stack: A1,A2,...,Alen --- A
...
//
// A szemétgyûjtés a gráf bejárásakor nem használja az
...
int valuecompare(const void *x, const void *y)
{
    ...
    //engedni kell a szemétgyûjtést, máskülönben deadlock keletkezik,
    ...
    // hogy detektálható legyen az egyenlõ eset. A Clipperben
    // megadható kódblock nem szimmetrikus (csak T/F-et ad),
    // és ezért az egyenõ elemeket tartalmazó array-re a qsort
