...
//2004.08.23
//A külsõ static változók inicializálása szinkronizált.
//Ezért clid_object külsõ definíciója biztosítja, hogy többszálú
...
local clid:=classRegister("object",NIL) //osztálynév, {baseid}
    ...
    classMethod(clid,"methnames"    ,{|this|classMethNames(getclassid(this))})
