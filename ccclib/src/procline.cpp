...
void _clp_localstack(int argno)
{
    ...
    localstack() lehetõvé teszi, hogy a lokális
    stack alján levõ változókban a szálra specifikus, 
    a szálban globális adatokat tároljunk.

    Thread-specifikus static változókat körülményes volna 
    CCC-ben implementálni, sokkal egyszerûbb megengedni, 
    ...
    akkor is megkaphatók a lokális stacken levõ változók. 
