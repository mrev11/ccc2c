...
//Ennek mintájára lehet saját szignálkezelõket írni.
//
...
//és a szignálkezelõbõl újra meg akarná fogni ugyanazt a mutexet, 
//akkor deadlock keletkezne.
//    
//Ha az egész programot kell védeni a SIGINT-tõl (váratlan kilépéstõl),
...
function setposixsignal(onoff)
    ...
    //A felgyûlt szignálok csak itt (MUTEX_UNLOCK után) jutnak érvényre,
