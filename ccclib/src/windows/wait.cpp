...
//Win32 HANDLE, amire várni lehet WaitForSingleObject-tel,
//pl. thread_mutex_lock( spawn(.f.,"program.exe") ) vár.
//
//Borland-ban a pid NEM HANDLE, azért a fenti várakozás nem megy.
//Borlandban implementálva van a tesztõleges childra váró wait,
//ami MSVC-bõl és MinGW-bõl hiányzik. Ezek pid=0-val sem tudnak várni.
//
