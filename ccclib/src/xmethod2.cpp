...
//
//Az xmethod modulban a különbözõ típusú metódus osztályokat
//egymástól függetlenül definiáltuk (kompatibilitási okokból),
//ez azonban nehezítette a karbantartást a kódismétlések miatt.
//Az xmethod2 modulban alkalmazzuk az öröklõdést, a findslot-ot
...
//csinál, ezek már az xmethod2-vel mûködnek. A kézzel írt C++
...
void _method2_::findslot(int clid)
{
    ...
    //Ezt a blokkot/indexet megõrizzük a slot memberben,
