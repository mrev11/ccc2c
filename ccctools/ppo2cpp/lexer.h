...
class ppo2cpp_lexer : public yyFlexLexer
{
    ...
    parsenode *getnext()
    {
        ...
        //Mindent, ami nem string kisbetûre konvertálunk,
        //ezzel véglegesen biztosítva lesz a case insensitivity.

        if( (id!=STRING) && (id!=NLSTEXT) )
        {
            int i=0;
            while( *(txt+i)!=0 )
            {
        ...
        //a belsõ "-ket \"-vel, a \-eket \\-vel védeni kell.
        ...
        //A számok elejérõl a felesleges 0-kat levesszük,
        //hogy a C fordító ne akarja ôket oktálisnak értelmezni.
