...
def jtautostart(p1=None,p2=None):
    ...
    # ennek a mûködése azon alapszik,
    # hogy mire a Jáva (jterminal) elõkászálódik,
    # addigra mi már rég az alábbi accept-ben várunk,
    # és fogadni tudjuk a terminál konnektálását
