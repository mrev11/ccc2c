...
#define VERZIO "0.2.00"    //2006.01.07 kulcsszavak kikerülve (class,new,method,attrib)

//#define VERZIO "0.1.05"    //2003.10.02 sorok vége javítva
//#define VERZIO "0.1.04"  Build-be integrálva
//#define VERZIO "0.1.03"  méretezés
//#define VERZIO "0.1.02"  jttable alosztályai
//#define VERZIO "0.1.01"  password mezõk
...
*****************************************************************************
static function concat(list,c)  //az üres c-vel bõvít egy komponenst
local n,d
    for n:=1 to len(list)
        d:=list[n]
...
local n,t,l,b,r,nm,tx,cl
    ...
    for n:=1 to len(list)
        ...
        elseif( list[n]:type=="table" )
            ...
            //választunk a név kezdõbetûje szerint
