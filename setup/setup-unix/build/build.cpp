...
//
    ...
    if(!flag()) goto if_9_1;
        line(133);
        string("BUILD_BAT environment not set");
        _clp_qqout(1);
        pop();
        _clp_qout(0);
        pop();
    ...
    if(!flag()) goto if_10_1;
        line(137);
        string("BUILD_BAT directory does not exist [");
        _clp_buildenv_bat(0);
        add();
        string("]");
        add();
    ...
    if(!flag()) goto if_11_1;
        line(141);
        string("BUILD_BAT directory does not contain script for prg2ppo [");
        _clp_buildenv_bat(0);
        add();
        string("]");
        add();
