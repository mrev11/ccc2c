...
//
    ...
    if(!flag()) goto if_32_1;
        ...
        string(nls_text("no exported method"));
...
//
    ...
    if(!flag()) goto if_33_1;
        ...
        string("' ");
        add();
        string(nls_text("not a valid classname"));
        add();
        _o_method_description.eval(2);
        pop();
        line(376);
...
//
    ...
    if(!flag()) goto if_41_1;
        ...
        string("' ");
        add();
        string(nls_text("is not parent of"));
        add();
        string(" '");
        add();
        push_symbol(base+3);//classname
...
//
    ...
    if(!flag()) goto if_46_1;
        ...
        string(nls_text("prohibited method cast"));
        _o_method_description.eval(2);
        pop();
        line(500);
        push_symbol(base+5);//err
    ...
    if(!flag()) goto if_47_1;
        ...
        line(508);
        push_symbol(base+5);//err
        string(nls_text("prohibited attribute cast"));
        _o_method_description.eval(2);
        pop();
        line(509);
        push_symbol(base+5);//err
