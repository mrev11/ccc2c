...
//------------------------------------------------------------------------
int equalto()  // szigorú (nem Clipper =, != ...) egyenlõség
    ...
    else if( a->type==b->type )
    {
        switch( a->type )
        {
            case TYPE_STRING:
            {
                ...
                if( al!=bl )
                    result=0; // különbözõ hosszúak --> nem egyenlõ
                else if( al==0 )
                    result=1; // üresek --> egyenlõ
                else
                {
                    //egyik sem üres --> van mutatójuk
                    char *ap=STRINGPTR(a);
                    char *bp=STRINGPTR(b);
    ...
    else if( a->type==b->type )
    {
        switch( a->type )
        {
            case TYPE_STRING:
            {
                ...
                if( bl==0 )
                {
                    result=0; //a jobboldal hosszában egyezik --> egyenlõ
                }
                else if( al<bl )
                {
                    result=1; // a jobboldal hosszabb --> nem egyenlõ
                }
                else
                {
                    char *ap=STRINGPTR(a);
        ...
        switch( a->type )
        {
            case TYPE_STRING:
            {
                ...
                else
                {
                    ...
                    // a nem lehet nagyobb, ha elõbb van eltérés,
