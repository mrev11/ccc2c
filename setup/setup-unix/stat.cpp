...
//csak a readonly attribútumnak van jelentôsége.
...
static void createStatEntry(struct stat *buf)
{
    ...
    number((double)(unsigned long long)buf->st_atime);
    number((double)(unsigned long long)buf->st_mtime);
    number((double)(unsigned long long)buf->st_ctime);
