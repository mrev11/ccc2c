...
//Változótáblák méretének és szemétgyûjtés paramétereinek felülírása:
//
...
//mûködni a szemétgyûjtés. Ha ezt egy alkalmazás meg akarja változtatni,
...
void vartab_setsize( struct VARTAB_SETSIZE *vss )
{
   ...
   // ha az utolsó szemétgyûjtés után gyártott objektumok száma
   // túllépi alloc_count-ot, akkor beindul a szemétgyûjtés

   // *vss->alloc_size=0x200000L; //2MB
   // ha az utolsó szemétgyûjtés után gyártott objektumok összmérete
   // túllépi alloc_size-ot, akkor beindul a szemétgyûjtés
}
