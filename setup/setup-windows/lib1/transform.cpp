...
char *ParsePicture(VALUE*vp, int*tf)
{
    ...
    //function-stringjébõl kiolvasott flageket
...
void trn_string(VALUE *vs,VALUE *vp) //  --- string
{
    ...
    const char *s=len?STRINGPTR(vs):""; //formázandó string

    //nálunk a kimenet hossza mindig egyenlõ lesz a template hosszával,
...
void trn_number(VALUE *vs,VALUE *vp) //  --- string
{
    ...
    char *out=stringl(tlen); //másolat a template stringrõl
    ...
    //egész rész
    //tizedesponttól balra az elsõ karakter 
    ...
    //decimális rész
    //tizedesponttól jobbra az elsõ karakter 
