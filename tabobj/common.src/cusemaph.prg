...
//TARTALOM  : egyszerû szemafor protokol
//STATUS    : közös utility


#include "fileio.ch"

// egyszerû szemafor protokoll
//
...
//
// ezek közönséges file open/close mûveletek,
...
// a fõ nehézség, hogy meg kell állapodni a szemafor nevekben,
