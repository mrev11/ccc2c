...
RECPOS __bt_addresource(BTREE *t, DBT*data, indx_t index)
{
    ...
    // ha index<NEXTINDEX, akkor a nagyobb indexû rekordokat törli,
    ...
    mpool_count(t->bt_mp,"addresource-0");//ellenôrzés 
    ...
    mpool_count(t->bt_mp,"addresource-1");//ellenôrzés 
    return recpos;
}
...
RECPOS __bt_append(BTREE *t, DBT*data, int *recno)
{
    ...
    mpool_count(t->bt_mp,"append-0");//ellenôrzés 
    ...
    *recno=t->bt_nrecs;
    ...
    __bt_pageunlock(t,t->bt_lastdatapage);    
    __bt_header_write(t);
    mpool_count(t->bt_mp,"append-1");//ellenôrzés 
...
int __bt_read(BTREE *t, DBT*data, RECPOS *recpos)
{
    ...
    mpool_count(t->bt_mp,"read-0");//ellenôrzés 
    ...
    mpool_count(t->bt_mp,"read-1");//ellenôrzés 
    return recsiz;
}
...
int __bt_read1(BTREE *t, DBT*data, pgno_t pgno, indx_t index)
{
    ...
    mpool_count(t->bt_mp,"read1-0");//ellenôrzés 
    ...
    mpool_count(t->bt_mp,"read1-1");//ellenôrzés 
    return recsiz;
}
...
int __bt_rewrite(BTREE *t, DBT*data, RECPOS *recpos)
{
    ...
    mpool_count(t->bt_mp,"rewrite-0");//ellenôrzés 
    ...
    mpool_count(t->bt_mp,"rewrite-1"); //ellenôrzés
