...
#define TAB_FLDNUM      3   // mezõk száma a fájlban (nem az objektumban)
...
#define TAB_MODIFAPP   22   // új rekordot jelzõ flag
...
#define TAB_TRANLOCK   35   // az elsõ tranzakciós lock indexe
#define TAB_TRANDEL    36   // rollbackben törlendõ rekordok listája
 
#define TAB_SIZEOF     37


#define COL_NAME        1   // oszlop-, és egyben mezõnév
#define COL_TYPE        2   // típus: C,N,D,L
#define COL_WIDTH       3   // mezõszélesség
#define COL_DEC         4   // tizedesjegyek (0, ha TYPE!=N)
#define COL_PICT        5   // mezõ picture
#define COL_BLOCK       6   // mezõ setget block
#define COL_KEYFLAG     7   // része-e a mezõ valamelyik kulcsnak
#define COL_OFFS        8   // mezõ offset a rekordon belül 
#define COL_SIZEOF      8
