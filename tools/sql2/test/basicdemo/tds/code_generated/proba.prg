...
local filterlist:={}
    ...
    aadd(primarykey,c:=dummy:getcolumn("szamlaszam"));c:keyseg:=.t.//;c:notnull:=.t.
    aadd(primarykey,c:=dummy:getcolumn("devnem"));c:keyseg:=.t.//;c:notnull:=.t.
