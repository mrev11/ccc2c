...
function main()
    x1.x2.x3.x4.x5.fun()        //teljesen minõsített
    x2.x3.fun()                 //teljesen minõsített
    //x3.fun()                  //nincs ilyen
    return NIL
...
function x1.x2.x3.x4.x5.fun()
    ...
    x1.fun()                    //teljesen minõsített
    x1.x2.fun()                 //teljesen minõsített
    x1.x2.x3.fun()              //teljesen minõsített
    x1.x2.x3.x4.fun()           //teljesen minõsített
    //x1.x2.x3.x4.x5.fun()      //végtelen rekurzió volna

    //fun()                     //végtelen rekurzió volna (mint az elõzõ)
    .fun()                      //teljesen minõsített
