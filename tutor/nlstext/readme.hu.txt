Stringek automatikus cseréje többnyelvû programokban
====================================================

Egyelõre csak a prg-beli stringekrõl van szó.
...
és UTF-8 editorban egyformán kezelhetõ a program. (Sajnos sok magyar 
...
A sor a fordítandó (angol) szöveggel kezdõdik,
...
könyvtárakban található fordítások töltõdnek be.    
...
Másik alkalmazási lehetõség: Az eredeti forrásba nem angol
