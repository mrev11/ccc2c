...
# Hivási formák
#
# 1) make.b lib name               (statikus könyvtár minden cpp-bõl)
# 2) make.b so  name lib1 lib2 ... (so könyvtár minden cpp-bõl + lib-ek) 
# 2) make.b exe name lib1 lib2 ... (exe program minden cpp-bõl + lib-ek) 
#
...
# az adott Linux installációnak megfelelõen módosítani kell.
