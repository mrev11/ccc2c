...
#define STRINGPTR0(v)  ((v)->data.string.oref->ptr.chrptr)
#define STRINGPTR(v)   (STRINGPTR0(v)?STRINGPTR0(v):(PTRERROR(v),(char*)0))
...
#define CHRPTR0(i)     (PARPTR(i)->data.string.oref->ptr.chrptr)
#define CHRPTR(i)      (CHRPTR0(i)?CHRPTR0(i):(PTRERROR(PARPTR(i)),(char*)0))
...
#define _parc(i)       (ISSTRING(i)?PARC(i):(ARGERROR(),(char*)0))
#define _parclen(i)    (ISSTRING(i)?PARCLEN(i):0)
#define _para(i)       (ISARRAY(i)?ARRPTR(i):(ARGERROR(),(VALUE*)0))
...
//----------------------------------------------------------------------
#include <compat_ccc3.h> //CCC3 programok backportolásához
