...
#define DOSCONV_FNAME2LOWER      4  // a filénevet kisbetûre
#define DOSCONV_FNAMERTRIM       8  // a filénevet trimeli
#define DOSCONV_PATH2LOWER      16  // a path-t kisbetûre
#define DOSCONV_ENCODEFNAME     32  // ékezetes betûk átkódolása a filénévben
#define DOSCONV_ENCODEPATH      64  // ékezetes betûk átkódolása a pathban
...
// csak a következõk támogatottak:
// DOSCONV_BS2SLASH, DOSCONV_FNAMERTRIM,  
// DOSCONV_FNAME2LOWER, DOSCONV_PATH2LOWER 


//----------------------------------------------------------------------------
// directory() mûködését szabályozó flag-ek
//----------------------------------------------------------------------------
 
#define DOSCONV_FNAME_UPPER    512  // directory() nagybetûsíti a filéneveket
#define DOSCONV_FSPEC_ASTERIX 1024  // directory() a *.*-ot lecseréli *-ra
#define DDOSCONV_ALL          1536

//----------------------------------------------------------------------------
// fopen(), fcreate() mûködését szabályozó flag-ek
//----------------------------------------------------------------------------
...
// getenv(), setenv(), putenv() mûködését szabályozó flag-ek

#define DOSCONV_ENVVAR2UPPER  8192  // nagybetûre konvertál
